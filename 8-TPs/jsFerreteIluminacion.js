...
E. Si el importe final con descuento suma más de $120 se debe sumar un 10% de ingresos brutos
 en informar del impuesto con el siguiente mensaje: ”Usted pago X de IIBB.”, siendo X el
...
function CalcularPrecio () 
{
 	...
 	if(precioDescuento>120)
 		{
 		var ingresosBruto=(precioDescuento*0.1);
	...
	if(precioDescuento>120)
		{
 		...
 		precioDescuento=precioDescuento+ingresosBruto;
 		}
